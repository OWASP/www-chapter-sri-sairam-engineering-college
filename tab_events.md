...
Ready to dive into the world of ethical hacking, but not sure where to start?

Join our exclusive webinar for beginners on Capture The Flag (CTF) challenges and learn how real hackers think (and how not to get arrested doing it 😅).

### Join us for an exciting webinar:

🔐 **Hack Your Way In: CTF for Beginners**

📅 **Date:** 13th July 2025 (Sunday)

🕕 **Time:** 06:00 PM – 07:30 PM

📍 **Online** | Open to all cyber enthusiasts

### 🎙️ Speaker:

**Karthik D**, Intern @ Centre for Cybersecurity, Trust and Reliability, IIT Madras (CyStar), CTF Player@TamilCTF.

💡 Dive into the fundamentals of CTFs, get hands-on insights, and understand how these challenges help you grow in ethical hacking and infosec.

### 👨‍💻 Student Lead: 
**Kannan K** (II Year, Cyber Security)
...
👩‍🏫 **Dr.Soma Prathibha** (HoD – CSE Cyber Security)

👨‍💼 **Raja J** (Principal, Sri Sairam Engineering College)

🎓 **Sai Prakash LeoMuthu** (Chairman & CEO, Sairam Institutions)

🧠 Whether you're a student, a beginner in cybersecurity, or someone just curious about how real-world hacking simulations work — this session is your gateway into the world of ethical hacking.
...
Today at Sri Sairam Engineering College, we had an impactful seminar on Cybersecurity Career Path & Skill Development, organized by the **SAIRAM - CSE(Cyber Security)** in association with our **OWASP Sri Sairam Engineering College Chapter**.

### The session focused on:

- Core cybersecurity fundamentals 🔎

- Industry-relevant skillsets 🛠️

- Career pathways to grow in the security domain 📈

### We had the privilege of learning from:

**Sruthi Lakshmi Mallapu Srinivasan** – Freelance Security Consultant, Global Japan Pvt. Ltd.

**Mr. N S Bharath Kumar** – Senior Staff, Product Security, ServiceNow Pvt. Ltd.

Their insights provided much-needed clarity on how to navigate a career in cybersecurity while staying industry-ready.

### A heartfelt thanks to:

👩‍🏫 **Dr.Soma Prathibha** – HoD, CSE (Cyber Security)

👨‍🏫 Our dedicated staff members who made this possible

👨‍💼 **Raja J** - Principal, Sri Sairam Engineering College

🎓 **Sai Prakash LeoMuthu** – Chairman & CEO, Sairam Institutions, for his continued support

Sessions like these not only expand our knowledge but also inspire us to explore, learn, and build stronger foundations in cybersecurity.
...
I'm beyond excited to share something I've been building for a while —

💻 **A dedicated website exclusively for our SAIRAM Cybersecurity community!** with the support of **OWASP Sri Sairam Engineering College Chapter**. This platform is made by a Sairamate, for Sairamates — a private space where our cybersecurity enthusiasts can:

⚔️ **Compete in CTFs under one banner — 3XPL0IT3RS**, weekly internal CTF's

📚 **Share their challenge write-ups and walkthroughs**

🚀 **Learn, collaborate, and level up together** in the world of cybersecurity

This isn't just a site — it's a community hub where passion for ethical hacking meets real teamwork. And yes, only Sairam students get access — because this one's for the home team. 💪
